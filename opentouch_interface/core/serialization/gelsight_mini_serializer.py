...
@SerializerClassRegistry.register('GelSight Mini')
class GelSightMiniSerializer(BaseSerializer):
    """Serializer for the GelSight mini sensor (camera-based touch sensor)."""
